<?php
  include "model/fetchPost.php";
  include "model/fetchCommentsRecipe.php";
?>
      ...
      <div class="col-lg-8 pl-lg-0 offset-lg-3 offset-0">
        <nav class="post-navigation row mb-4 mt-lg-0 mt-5 py-4 text-left">
          <div id="rate" class="post-prev col-12 pr-sm-5">
            ...
            ?>
            <h4 class="side-title mb-2"><a href="login.php" style="font-size: 28px;">Log in</a> to rate</h4>
            <?php
              endif;
            ?>
            <?php
        ...
        <div class="leave-comment-form mt-5" id="reply">
          ...
          ?>
          <h5><a href="register.php">Sign in</a> to post a comment!</h5>
          <?php
            endif;
          ?>
        </div>
