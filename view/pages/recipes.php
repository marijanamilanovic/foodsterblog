  ...
  <div class="container py-lg-3">
    ...
    <div class="row abouthy-img-grids">
      ...
      <div class="col-lg-6 col-md-6 blog2-posts">
        <a href="recipe.php?id=<?=$d['idPost']?>" data-id=<?=$d['idPost']?> class="blog-article-post d-block p-0">
    ...
    <div class="pagination-wrapper mt-5 text-center d-flex justify-content-center">
      ...
      <ul class="page-pagination">
        <li><a class="previous" href="<?php
          ...
          echo $_SERVER['PHP_SELF']."?page=".$previous.$addition;
        ...
        <?php
          ...
          for($i=0; $i<$numberOfPages; $i++):
            $count=$i+1;
        ?>
        <li><a class="page-numbers" href="<?php
          $addition = "";
          if(isset($_GET['category'])){
            $addition .= '&category='.$_GET['category'];
          }
          ...
          echo $_SERVER['PHP_SELF']."?page=".$count.$addition;
        ?>"
        <?php
          if($count==$current){
            echo "class='current'";
      ...
      <ul class="page-pagination">
        ...
        <li><a class="next" href="<?php
          ...
          echo $_SERVER['PHP_SELF']."?page=".$next.$addition;
